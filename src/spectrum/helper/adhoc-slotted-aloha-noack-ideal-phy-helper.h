...
#ifndef ADHOC_SLOTTED_ALOHA_NOACK_IDEAL_PHY_HELPER_H
#define ADHOC_SLOTTED_ALOHA_NOACK_IDEAL_PHY_HELPER_H
 ...
 */
class AdhocSlottedAlohaNoackIdealPhyHelper  : public ns3::PcapHelperForDevice
{
public:
  AdhocSlottedAlohaNoackIdealPhyHelper ();
  ~AdhocSlottedAlohaNoackIdealPhyHelper ();
